    ...
    <div className="min-h-screen bg-[#0a130d]">
      ...
      <section className="pt-36 pb-20 px-6 md:px-8 bg-[#0a130d] border-b border-white/10">
        <div className="max-w-[1120px] mx-auto grid lg:grid-cols-[1.1fr_0.9fr] gap-10 lg:gap-14 items-end">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white leading-[0.94] tracking-tight">
            ...
            <p className="text-lg text-white/50 mt-8 max-w-2xl leading-relaxed">
              GatePass starts with HOA transition pain, then turns the community into a controlled-access layer for verified home-improvement contractors.
            </p>
          ...
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.12, duration: 0.7 }} className="bg-[#101d14] border border-white/10 rounded-[28px] p-6 md:p-8 shadow-2xl shadow-black/20">
            ...
            <p className="text-sm text-white/45 leading-relaxed">
              The round is for one diligence target: convert the demo loop into a first paid HOA + contractor transaction loop before the Aug. 22–23 Austin Home Show path.
            </p>
      ...
      <section className="py-20 px-6 md:px-8 bg-[#0d1a12] border-b border-white/10">
        <div className="max-w-[1120px] mx-auto grid lg:grid-cols-[0.85fr_1.15fr] gap-10">
          <div>
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-white mt-5 leading-tight">What has to become real.</h2>
            <p className="text-white/45 mt-5 leading-relaxed">This should read like an investor memo with a clean proof boundary, not a public name-drop list.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-3">
            {diligence.map(([title, body], index) => (
              <div key={title} className="bg-white/[0.04] border border-white/10 rounded-3xl p-6 min-h-[210px]">
      ...
      <section className="py-20 px-6 md:px-8 bg-[#f4f1ec]">
        <div className="max-w-[1120px] mx-auto">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-[#1C1C1A] mt-5 mb-10 leading-tight">The market is funded. The transition moment is still open.</h2>
          <div className="grid md:grid-cols-3 gap-3">
            {marketProof.map(([name, figure, meaning]) => (
              <div key={name} className="bg-white border border-[#2A5240]/10 rounded-3xl p-6 shadow-sm">
          ...
          <div className="mt-6 p-6 md:p-7 bg-[#2A5240] rounded-3xl text-white text-sm md:text-base leading-relaxed">
      ...
      <section className="py-20 px-6 md:px-8 bg-[#0a130d]">
        <div className="max-w-[1120px] mx-auto grid lg:grid-cols-[0.9fr_1.1fr] gap-12 items-start">
          <div>
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-white mt-5 leading-tight">Capital goes into proof, not theater.</h2>
