...
export default function AdminConsole() {
  ...
  return (
    <div style={{ background: C.cream, color: C.charcoal, minHeight: "100vh", fontFamily: "'Geist', system-ui, sans-serif" }}>
      <header style={{ borderBottom: `1px solid ${C.line}`, padding: "20px 28px", display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "minmax(180px,260px) 1fr minmax(240px,320px)", minHeight: "calc(100vh - 74px)" }}>
        <nav style={{ borderRight: `1px solid ${C.line}`, padding: "16px 0" }}>
          {STEPS.map((step) => {
        ...
        <aside style={{ borderLeft: `1px solid ${C.line}`, padding: "20px 22px", background: "#EFEADD" }}>
