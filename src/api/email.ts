...
export async function sendContractorConfirmation(input: {
  ...
  await send(
    input.to,
    `Your approved GatePass contractor access is confirmed`,
    `<!DOCTYPE html>
<html>
<head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"></head>
<body style="margin:0;padding:0;background:#F4F1EC;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;">
    ...
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;border:1px solid #D4CFC6;">
        ...
        <tr><td style="background:#B8883A;padding:32px 40px;">
          <p style="margin:0;color:rgba(255,255,255,0.7);font-size:11px;letter-spacing:0.1em;text-transform:uppercase;font-family:'Courier New',monospace;">GatePass · Contractor Access</p>
          <h1 style="margin:8px 0 0;color:#ffffff;font-size:26px;font-weight:700;letter-spacing:-0.02em;">Founding access confirmed.</h1>
        </td></tr>
        <!-- Body -->
        <tr><td style="padding:40px;">
          <p style="margin:0 0 20px;color:#4A4A44;font-size:15px;line-height:1.7;">Hi ${input.name},</p>
          <p style="margin:0 0 20px;color:#4A4A44;font-size:15px;line-height:1.7;">
            <strong>${input.company}</strong> has completed payment after approval for founding contractor access in the Austin metro.
          </p>
          <!-- Receipt box -->
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#FDF8EF;border-radius:6px;border:1px solid rgba(184,136,58,0.2);margin:0 0 28px;">
            <tr><td style="padding:20px 24px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-top:12px;">
                ...
                <tr style="border-top:1px solid #D4CFC6;">
                  <td style="color:#B8883A;font-size:14px;font-weight:700;padding-top:12px;">Access</td>
                  <td align="right" style="color:#B8883A;font-size:14px;font-weight:700;padding-top:12px;">Founding contractor</td>
                </tr>
              </table>
            </td></tr>
          </table>
          <p style="margin:0 0 20px;color:#4A4A44;font-size:15px;line-height:1.7;">
            Your $99 founding-access payment is recorded. Each association still decides which contractors may enter its approved channel, and no lead or job volume is guaranteed.
          </p>
          <p style="margin:0;color:#4A4A44;font-size:15px;line-height:1.7;">— The GatePass Team</p>
        </td></tr>
        <!-- Footer -->
